...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        _______, KC_LCTL, KC_LALT, KC_LSFT, KC_BTN1, TH_BTN3_F,                                           _______, _______, _______, _______, _______,  _______,
        _______, _______, _______, _______, TH_BTN2_V, _______,                                           _______, _______, _______, _______, _______,  _______,
                          _______, _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______, _______ \
        ),
        ...
        _______, KC_MINS, KC_4, KC_5, KC_6, KC_EQL,                                           _______, KC_LCTL, KC_LSFT, KC_ALT, KC_LGUI,  _______,
        ...
        _______, KC_F11,  KC_F4,   KC_F5,   KC_F6,   KC_F12,                                                     _______, KC_LCTL, KC_LSFT,  KC_ALT, KC_LGUI,  _______,
        ...
        KC_LCTL, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                                           KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH,  KC_Q,
                          KC_GUI,  KC_ESC,  KC_SPACE, KC_F2, KC_F1, KC_H,       _______, KC_BSPC, _______, _______, _______, _______ \
