...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        [_MOUSE] = LAYOUT( \
        _______, _______, _______, _______, _______, _______,                                           _______, _______, _______, _______, _______,  _______,
        _______, _______, _______, EH_SCR,  TH_TRNS_R, TH_TRNS_T,                                           _______, _______, _______, _______, _______,  _______,
        _______, KC_LCTL, KC_LALT, KC_LSFT, KC_BTN1, TH_BTN3_F,                                           _______, _______, _______, _______, _______,  _______,
        _______, TH_TRNS_Z, TH_TRNS_X, TH_TRNS_C, TH_BTN2_V, TH_TRNS_B,                                           _______, _______, _______, _______, _______,  _______,
                          _______, _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______, _______ \
        ),
        ...
        _______, C(KC_A), C(KC_S), LSFT_T(C(KC_D)), _______, C(KC_F),                                   C(KC_H), C(KC_J), C(KC_K), C(KC_L), C(KC_SCLN),  _______,
        _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), C(KC_B),                                           C(KC_N), C(KC_M), C(KC_COMM), C(KC_DOT), C(KC_SLS),  _______,
                          _______, _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______, _______ \
        ...
        _______, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                                              KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLS,   _______,
                          _______, _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______, _______ \
