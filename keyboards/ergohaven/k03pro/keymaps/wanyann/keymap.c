...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        _______, _______, C(A(KC_GRV)), HYPR(KC_TAB), HYPR(KC_F1), _______,                                           _______, _______, _______, _______, _______,  _______,
        _______, LGUI_T(C(KC_KC_LBRC)), LALT_T(C(KC_KC_RBRC)), KC_LSFT, KC_LCTL, _______,                                           _______, _______, _______, _______, _______,  _______,
        _______, _______, _______, _______, _______, _______,                                           _______, _______, _______, _______, _______,  _______,
                          _______, _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______, _______ \
